<template>
  <transition name="list-fade">
    <div class="playlist" v-show="showFlag" @click="hide">
      <div class="list-wrapper" @click.stop>
        <div class="list-header">
          <h1 class="title">
            ...
            <span class="text">{{textIcon}}</span>
            <span class="clear" @click="deleteAllSongsIcon"><i class="icon-clear"></i></span>
          </h1>
        </div>
        <Scroll :refreshDelay="refreshDelay" class="list-content" ref="scroll" :data="sequenceList">
      ...
      <confirm @confirm="deleteAll" text="是否清空列表所有歌曲" confirmBtnText="清空" ref="confirm"></confirm>
